...
class PassportScannerScreen extends GetView<PassportScannerController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GetBuilder<PassportScannerController>(
        init: controller,
        builder: (_) {
          return Obx(() {
      ...
      children: [
        ...
        Positioned(
          ...
          child: Container(
            ...
            child: CommonText(
              text: 'Position passport in frame with photo visible',
              color: AppColors.backgroundColor,
          ...
          child: Container(
            ...
            child: Row(
              ...
              children: [
                ...
                GestureDetector(
                  onTap: controller.capturePassport,
                  child: Container(
                ...
                // Auto capture is always ON for passport
                    ...
                    Expanded(
                      child: Obx(() => ElevatedButton.icon(
                            onPressed: controller.isProcessing.value
                                ? null
                                : controller.confirmAndSavePassport,
...
class PassportFramePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // Adjusted frame size for passport - passport is slightly larger than ID card
    final frameWidth = size.width * 0.8;  // Passport is wider than ID card
    final frameHeight = frameWidth / 1.414;  // Standard passport aspect ratio (ISO/IEC 7810 ID-3)
